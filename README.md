...
```
wget https://github.com/6block/zkwork_subspace_farmer/releases/download/zkwork-mainnet-2024-nov-06/zkwork-mainnet-2024-nov-06.tar.gz
tar -zvxf zkwork-mainnet-2024-nov-06.tar.gz
```
